    ...
    <div class="card foglio">
      <div class="row">
          ...
          <div class="col">
            ...
            <?php
            if ($data['age']>8)
            echo "<p>This is a senior pet and needs special attentions." .$data['name']." was given for adoption from ".$data['adoptable']. " and since has lived in a protected enviroment. </p>";
            else
