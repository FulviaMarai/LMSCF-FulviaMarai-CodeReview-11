...
if ($_GET) {
  ...
  $coordLon= $_GET['coordLon'];
   ...
   $sql = "INSERT INTO pet (name, photo, breed, age, adoptable, description, hobbies, web, location, image, address, city, ZIP, coordLat, coordLon) VALUES ('$name','$photo','$breed','$age','$adoptable','$description','$hobbies','$web', '$location','$image','$address','$city','$ZIP','$coordLat','$coordLon')";
